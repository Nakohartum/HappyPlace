...
class DatabaseHandler(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_HAPPY_PLACE_TABLE = ("CREATE TABLE $TABLE_HAPPY_PLACES($KEY_ID INTEGER PRIMARY KEY," +
                "$KEY_TITLE TEXT, $KEY_IMAGE TEXT, $KEY_DESCRIPTION TEXT, $KEY_DATE TEXT, $KEY_LOCATION TEXT," +
    ...
    fun updateHappyPlace(happyPlace: HappyPlaceModel) : Int{
        ...
        val result = db.update(TABLE_HAPPY_PLACES, contentValues, KEY_ID + "=" + happyPlace.id, null)
        db.close()
        return result
    }
    ...
    fun getHappyPlacesList():ArrayList<HappyPlaceModel>{
        ...
        val query = "SELECT * FROM $TABLE_HAPPY_PLACES"
